...
type AboutSectionModel = Model<IAboutSection, object>;
...
const aboutSectionSchema = new Schema(
  {
    ...
    missionPillars: {
      ...
      required: true,
      validate: {
        validator: function(pillars: any[]) {
...
const AboutSectionModel = model<IAboutSection, AboutSectionModel>("AboutSection", aboutSectionSchema);
