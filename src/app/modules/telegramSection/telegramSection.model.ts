...
type TelegramSectionModel = Model<ITelegramSection, object>;
...
const pricingPointSchema = new Schema({
  text: {
    type: String,
    required: true,
  },
...
const sponsoredAdSchema = new Schema({
  label: {
    type: String,
    required: true,
  },
...
const futureBannerSchema = new Schema({
  title: {
    type: String,
    required: true,
  },
...
const telegramSectionSchema = new Schema(
  {
    title: {
      type: String,
      required: true,
...
const TelegramSectionModel = model<ITelegramSection, TelegramSectionModel>("TelegramSection", telegramSectionSchema);
export default TelegramSectionModel;
