 ...
 */
router.post('/', (0, authGuard_1.default)(), fileUploadAndConvertToWebP_1.default, testimonials_controller_1.TestimonialController.createTestimonial);
/**
 ...
 * @apiError {Object} error Error message
 */
router.patch('/:id', (0, authGuard_1.default)(), fileUploadAndConvertToWebP_1.default, testimonials_controller_1.TestimonialController.updateTestimonial);
/**
 ...
 * @apiError {Object} error Error message
 */
router.delete('/:id', (0, authGuard_1.default)(), testimonials_controller_1.TestimonialController.deleteTestimonial);
