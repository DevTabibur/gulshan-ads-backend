...
const createTestimonial = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (files && files.imageUrl && Array.isArray(files.imageUrl) && files.imageUrl.length > 0) {
        authorImage = files.imageUrl.map((file) => (0, convertImageToWebP_1.default)(file.filename));
    }
    const data = {
    ...
    const result = yield testimonials_service_1.TestimonialService.createTestimonial(data);
...
const updateTestimonial = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield testimonials_service_1.TestimonialService.updateTestimonial(id, data);
    (0, sendSuccessResponse_1.sendSuccessResponse)(res, {
        statusCode: http_status_1.default.OK,
