...
const metaPricingSectionSchema = new mongoose_1.Schema({
    title: {
        type: String,
        required: true,
    },
...
const MetaPricingSectionModel = (0, mongoose_1.model)("MetaPricingSection", metaPricingSectionSchema);
exports.default = MetaPricingSectionModel;
